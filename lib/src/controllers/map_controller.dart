...
class MapController extends ControllerMVC {
  ...
  Future<void> listenForNearMarkets(Address myLocation, Address areaLocation) async {
  ...
  Future<void> getCurrentLocation() async {
    try {
      setState(() {
        ...
        if (!currentAddress.isUnknown()) {
          print("! isUnknown ${currentAddress.latitude}");
  ...
  Future<void> getMarketLocation() async {
    try {
     ...
     await Helper.getMyPositionMarker(currentAddress.latitude, currentAddress.longitude).then((marker) {
        setState(() {
          allMarkers.add(marker);
  ...
  Future<void> getMarketsOfArea() async {
    setState(() {
      topMarkets = <Market>[];
